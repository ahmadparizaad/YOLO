...
def test_dampers():
    fields = ["damper_supply_air", "damper_return_air", "damper_fresh_air", "damper_bleed_air", "damper_coil_bypass"]
    ...
    for img_path in TEST_IMAGES:
        ...
        try:
            ...
            parsed_damper = pipeline.parse_damper_table(data.get("damper_table", []))
            
            # Use create_final_output to get normalized fields
            all_parsed = {"dampers": parsed_damper}
